...
nonisolated enum SampleData {
    static let issues: [Issue] = [
        make(
            "Freezer temperature has risen to 48°F.",
        ...
        make(
            "Water on the floor at the store entrance",
        ...
        make(
            "Receipt paper is running low at Register #3",
    ...
    // Test data factory
    // keep the parameters as they are since the shorter positional arguments are easier to read.
